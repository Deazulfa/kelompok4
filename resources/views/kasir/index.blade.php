...
<style>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Kasir</h1>
        ...
        <form id="pointOfSaleForm" enctype="multipart/form-data" method="POST" action="{{ route('index-pesanan') }}">
            ...
            <div class="row mb-0">
                <div class="col-md-12 d-flex justify-content-center mx-auto offset-md-12 mt-3">
                    <button type="button" class="btn btn-dark" onclick="addItem()"> + Tambahkan Item</button>
                </div>
            </div>

            <table class="table mt-4" style="border-bottom: 0px solid #8b8b8b;">
                <thead>
                    <tr>
